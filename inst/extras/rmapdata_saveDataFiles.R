...
library(tibble);library(dplyr);library(rgdal);library(devtools);library(rmapdata); library(tmaptools)
library(rgeos); library(rgcam); library(maptools); library(rnaturalearth);library(rmapdatashaper);
library(rmap)
...
if(redoMaps){
  ...
  mapx@data <- mapx@data%>%droplevels()%>%
    dplyr::mutate(area_sqkm=raster::area(mapx)/1000000)
  format(object.size(mapx), units="Mb")
  mapx<-rmapdatashaper::ms_simplify(mapx)
  format(object.size(mapx), units="Mb")
  #sp::plot(mapx)
...
if(redoMaps){
  ...
  # Mapping file is available in rmapdata::mappings.R
...
rmapdata::rmap::map(alaska)
# extract, then rotate & shift hawaii
hawaii <- us_aea[us_aea$STATEFP=="15",]
hawaii <- elide(hawaii, rotate=-35)
hawaii <- elide(hawaii, shift=c(5400000, -1400000))
proj4string(hawaii) <- proj4string(us_aea)
rmapdata::rmap::map(hawaii)
...
if(redoMaps){
  ...
  mapx@data <- mapx@data %>%
    dplyr::mutate(region="World",
                  ...
                  subRegion=case_when(subRegion.2 %in% rmapdata::mappings()$US52~subRegion.2,
                                      TRUE~subRegion.1),
                  subRegionAlt=case_when(subRegion.2 %in% rmapdata::mappings()$US52~1,
                                         TRUE~subRegionAlt.1),
...
if(redoMaps){
  ...
  maptools::unionSpatialPolygons(rmapdata::mapUS49, "subRegion")
...
if(F){
  ...
  #------------
  # World
  rgeos::gIsValid(rmapdata::mapCountries)
  rgeos::gIsValid(rmapdata::mapStates)
  # GCAM
  rgeos::gIsValid(rmapdata::mapGCAMReg32)
  rgeos::gIsValid(rmapdata::mapGCAMBasins)
  rgeos::gIsValid(rmapdata::mapGCAMLand)
  # US
  rgeos::gIsValid(rmapdata::mapUS52)
  rgeos::gIsValid(rmapdata::mapUS52County)
  rgeos::gIsValid(rmapdata::mapUS49)
  rgeos::gIsValid(rmapdata::mapUS49County)
  # HydroSheds
  rgeos::gIsValid(rmapdata::mapHydroShed1)
  rgeos::gIsValid(rmapdata::mapHydroShed2)
  rgeos::gIsValid(rmapdata::mapHydroShed3)
  # USGS HUC
  rgeos::gIsValid(rmapdata::mapUS52HUC2)
  rgeos::gIsValid(rmapdata::mapUS52HUC4)
  rgeos::gIsValid(rmapdata::mapUS49HUC2)
  rgeos::gIsValid(rmapdata::mapUS49HUC4)

  # Plotting
  #-------------
  # World
  rmap::map(data=rmapdata::mapCountries,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapStates,fillColumn = "subRegion",labels=F,save=F)

  # GCAM
  rmap::map(data=rmapdata::mapGCAMReg32,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapGCAMBasins,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapGCAMLand,fillColumn = "subRegion",labels=F,save=F)
  # US
  rmap::map(data=rmapdata::mapUS52,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapUS52County,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapUS49,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapUS49County,fillColumn = "subRegion",labels=F,save=F)
  # HydroSheds
  rmap::map(data=rmapdata::mapHydroShed1,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapHydroShed2,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapHydroShed3,fillColumn = "subRegion",labels=F,save=F)
  # USGS HUC
  rmap::map(data=rmapdata::mapUS52HUC2,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapUS52HUC4,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapUS49HUC2,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapUS49HUC4,fillColumn = "subRegion",labels=F,save=F)
  # Merge
  rmap::map(data=rmapdata::mapGCAMReg32US52,fillColumn = "subRegion",labels=F,save=F)
  # Intersections
  rmap::map(data=rmapdata::mapIntersectGCAMBasin32Reg,fillColumn = "subRegion",labels=F,save=F)
  rmap::map(data=rmapdata::mapIntersectGCAMBasinCountry,fillColumn = "subRegion",labels=F,save=F)
  # Grids
  rmapdata::grid025
  rmapdata::grid050
